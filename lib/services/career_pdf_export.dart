...
class CareerPdfExport {
  ...
  static pw.Widget _disclaimer() => pw.Container(
    ...
    child: pw.Text(
      'Personal professional-development document generated by Responder Roadmap. Verify official credentials, personnel records, promotional eligibility, and department requirements with the appropriate authority.',
