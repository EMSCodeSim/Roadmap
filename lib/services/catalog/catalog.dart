...
final List<CertificationDefinition> _certifications = <CertificationDefinition>[
  ...
  CertificationDefinition(
    ...
    description: 'Supervisory company-officer certification (name and delivery vary by state/provider).',
    aliases: const ['Fire Officer 1', 'Company Officer I', 'FO1'],
    ...
    resourceIds: const [],
    searchKeywords: const ['fo i', 'fo1', 'fire officer i', 'company officer'],
    renewalDescription: null,
    continuingEducationNotes: null,
    renewalResourceIds: const [],
  ),
  CertificationDefinition(
    ...
    shortName: 'FO II',
    category: CertificationCategory.officer,
    description: 'Mid-level officer certification for multi-company / battalion responsibility.',
    aliases: const ['Fire Officer 2', 'FO2'],
    ...
    nationalCredential: false,
    issuingOrganizations: const ['State fire authority / AHJ', 'IFSAC / Pro Board (where applicable)'],
    relatedCareerGoalIds: const ['ops_battalion_chief'],
    resourceIds: const [],
    searchKeywords: const ['fo ii', 'fo2', 'fire officer ii'],
    renewalDescription: null,
    continuingEducationNotes: null,
    renewalResourceIds: const [],
  ),
  CertificationDefinition(
    ...
    shortName: 'FO III',
    category: CertificationCategory.officer,
    description: 'Senior officer / administrative leadership certification.',
    aliases: const ['Fire Officer 3', 'FO3'],
    ...
    nationalCredential: false,
    issuingOrganizations: const ['State fire authority / AHJ', 'IFSAC / Pro Board (where applicable)'],
    relatedCareerGoalIds: const ['ops_division_chief'],
    resourceIds: const [],
    searchKeywords: const ['fo iii', 'fo3', 'fire officer iii'],
    renewalDescription: null,
    continuingEducationNotes: null,
    renewalResourceIds: const [],
  ),
  CertificationDefinition(
    ...
    shortName: 'FO IV',
    category: CertificationCategory.officer,
    description: 'Executive-level fire officer certification for senior / chief pathway roles.',
    aliases: const ['Fire Officer 4', 'FO4'],
    ...
    nationalCredential: false,
    issuingOrganizations: const ['State fire authority / AHJ', 'IFSAC / Pro Board (where applicable)'],
    relatedCareerGoalIds: const ['ops_deputy_chief', 'ops_fire_chief'],
    resourceIds: const [],
    searchKeywords: const ['fo iv', 'fo4', 'fire officer iv', 'executive fire officer'],
    renewalDescription: null,
    continuingEducationNotes: null,
    renewalResourceIds: const [],
  ),
  CertificationDefinition(
    ...
    description: 'Entry-level fire service instructor certification for delivering company-level training.',
    aliases: const ['Fire Instructor 1', 'Instructor I', 'FI1'],
    prerequisiteCertificationIds: const ['firefighter_1'],
    recommendedPrerequisiteIds: const [],
    typicallyExpires: false,
    typicalRenewalYears: null,
    ...
    relatedCareerGoalIds: const ['ops_company_officer'],
    resourceIds: const [],
    searchKeywords: const ['fi i', 'fi1', 'fire instructor i', 'instructor 1'],
    renewalDescription: null,
    continuingEducationNotes: null,
    renewalResourceIds: const [],
  ),
