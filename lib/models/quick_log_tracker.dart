...
extension QuickLogRolePresetX on QuickLogRolePreset {
  ...
  String get description => switch (this) {
        QuickLogRolePreset.medic =>
          'Procedures, resuscitation, and advanced patient care',
        QuickLogRolePreset.firefighter =>
          'Fire, rescue, and company-level skills',
        QuickLogRolePreset.engineer =>
          'Driving, pumping, water supply, and apparatus work',
        QuickLogRolePreset.officer =>
          'Command, leadership, training, and crew development',
      };
}
...
class QuickLogConfig {
  ...
  factory QuickLogConfig.fromJson(Map<String, dynamic> json) {
    ...
    return QuickLogConfig(
      rolePreset: preset,
      pinnedKeys:
          rawKeys is List ? rawKeys.whereType<String>().toList() : const <String>[],
      customTrackers: rawCustom is List
          ? rawCustom
              .whereType<Map>()
              .map((e) =>
                  QuickLogTracker.fromJson(Map<String, dynamic>.from(e)))
...
class QuickLogCatalog {
  static const List<QuickLogTracker> builtIns = [
    ...
    QuickLogTracker(
      keyName: 'safety.medical_exposure',
    ...
    QuickLogTracker(
      keyName: 'safety.hazard_exposure',
    ...
    QuickLogTracker(
      keyName: 'fire.hydrant',
      title: 'Hydrant supply',
      category: 'Driver / Operator',
      type: CareerRecordType.skill,
      iconName: 'hydrant',
    ),
    ...
    QuickLogTracker(
      keyName: 'fire.tender',
      title: 'Tender operation',
      category: 'Driver / Operator',
      type: CareerRecordType.skill,
      iconName: 'truck',
    ),
    QuickLogTracker(
      keyName: 'fire.apparatus_check',
      title: 'Apparatus check',
      category: 'Driver / Operator',
      type: CareerRecordType.skill,
      iconName: 'checklist',
    ),
    QuickLogTracker(
      keyName: 'officer.acting',
      title: 'Acting officer shift',
      category: 'Leadership',
      type: CareerRecordType.leadership,
      iconName: 'groups',
    ),
    QuickLogTracker(
      keyName: 'officer.command',
    ...
    QuickLogTracker(
      keyName: 'officer.training',
      title: 'Training delivered',
      category: 'Training',
      type: CareerRecordType.teaching,
      iconName: 'school',
    ),
    QuickLogTracker(
      keyName: 'officer.mentoring',
      title: 'Mentoring',
      category: 'Leadership',
      type: CareerRecordType.teaching,
      iconName: 'person',
    ...
    QuickLogTracker(
      keyName: 'officer.personnel',
      title: 'Personnel issue',
      category: 'Leadership',
      type: CareerRecordType.leadership,
      iconName: 'groups',
    ),
    QuickLogTracker(
      keyName: 'officer.project',
      title: 'Project / committee',
      category: 'Professional development',
      type: CareerRecordType.project,
      iconName: 'project',
    ),
    QuickLogTracker(
      keyName: 'officer.community',
  ...
  static QuickLogTracker? byKey(
    String key, [
    List<QuickLogTracker> custom = const [],
  ]) {
  ...
  static List<String> defaultsFor(QuickLogRolePreset preset) =>
      List<String>.from(roleDefaults[preset] ?? const <String>[]);
}
